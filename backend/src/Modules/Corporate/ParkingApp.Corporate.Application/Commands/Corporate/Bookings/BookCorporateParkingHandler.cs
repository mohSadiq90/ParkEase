...
internal sealed class BookCorporateParkingHandler
    : ICommandHandler<BookCorporateParkingCommand, ApiResponse<CorporateReservationResultDto>>
{
    ...
    public BookCorporateParkingHandler(
    ...
    public async Task<ApiResponse<CorporateReservationResultDto>> HandleAsync(
        BookCorporateParkingCommand command,
