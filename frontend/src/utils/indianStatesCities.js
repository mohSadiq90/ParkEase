/**
 * List of Indian states and their major cities for dropdowns
 */
export const INDIAN_STATES_CITIES = {
    ...
    "Arunachal Pradesh": [
        "Itanagar", "Tawang", "Pasighat", "Ziro", "Bomdila", "Aalo", "Tezu"
    ],
    "Assam": [
    ...
    "Himachal Pradesh": [
        "Shimla", "Manali", "Dharamshala", "Solan", "Mandi", "Palampur", "Baddi", "Nahan"
    ],
    "Jharkhand": [
        "Ranchi", "Jamshedpur", "Dhanbad", "Bokaro Steel City", "Deoghar", "Hazaribagh", "Giridih", "Ramgarh"
    ],
    "Karnataka": [
        "Bengaluru", "Mysuru", "Hubballi-Dharwad", "Mangaluru", "Belagavi", "Davangere", "Ballari", "Vijayapura", "Shivamogga", "Tumakuru"
    ],
    "Kerala": [
    ...
    "Maharashtra": [
        "Mumbai", "Pune", "Nagpur", "Thane", "Nashik", "Aurangabad", "Solapur", "Amravati", "Navi Mumbai", "Kolhapur", "Nanded"
    ],
    "Manipur": [
    ...
    "Uttar Pradesh": [
        "Lucknow", "Kanpur", "Ghaziabad", "Agra", "Varanasi", "Meerut", "Prayagraj", "Bareilly", "Aligarh", "Moradabad", "Noida", "Gorakhpur"
    ],
    "Uttarakhand": [
        "Dehradun", "Haridwar", "Roorkee", "Haldwani", "Rudrapur", "Kashipur", "Rishikesh"
    ],
    "West Bengal": [
        "Kolkata", "Howrah", "Asansol", "Siliguri", "Durgapur", "Bardhaman", "Malda", "Baharampur", "Habra"
    ],
...
export const STATES = Object.keys(INDIAN_STATES_CITIES).sort();

export default INDIAN_STATES_CITIES;
